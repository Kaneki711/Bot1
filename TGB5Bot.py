...
cl = LINETCR.LINE()
cl.login(token="Token Kamu/Token Admin")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Token Assist 1")

ki2 = LINETCR.LINE()
ki2.login(token="Token Assist 2")

ki3 = LINETCR.LINE()
ki3.login(token="Token Assist 3")

ki4 = LINETCR.LINE()
ki4.login(token="Token Assist 4")

ki5 = LINETCR.LINE()
ki6.login(token="Token Assist 5")

ki6 = LINETCR.LINE()
ki6.login(token="Token Assist 6")

ki7 = LINETCR.LINE()
ki7.login(token="Token Assist 7")

print "Login Success Boss"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""Ꭲ̡̦͎͇͈̘̻̎̉̅́̒͗ͅϵѧᴍ̸̩̟̗͎̯͙̺̺̜̬̙̟̀̑̓͋̐͆͌̓̒́̒͗͒͑̚͟͜ᎶʀҽѧᴛᏴøᴛ̢͓̹̗̘̠̪̖͗̃̄̅̆̽̀̕͜͞
...
⌨  Cᴀɴᴄᴇʟ     - Cᴀɴᴄᴇʟ Sᴇᴍᴜᴀ Pᴇɴᴅɪɴɢ Gʀᴜᴘ
...
⌨️  Sᴘᴀᴍ @  -  Mᴇɴɢsᴘᴀᴍ Pᴇsᴀɴ Vɪᴀ Tᴀɢ
⌨️  ᴋᴇᴅᴀᴘᴋᴇᴅɪᴘ - Mᴇᴍʙᴜᴀᴛ Tᴇxᴛ Mᴇɴᴊᴀᴅɪ Kᴇᴅᴀᴘᴋᴇᴅɪᴘ

 [⚙️] - ᴄᴏᴍᴍᴀɴᴅ ғᴏʀ sᴇᴛᴛɪɴɢ - [⚙️]    
⌨  [Lɪᴋᴇ ᴏɴ/ᴏғғ]     
⌨  [Aᴅᴅ ᴏɴ/ᴏғғ] 	 
⌨  [Aᴜᴛᴏ ᴊᴏɪɴ ᴏɴ/ᴏғғ] 	   
⌨  [Cᴏɴᴛᴀᴄᴛ ᴏɴ/ᴏғғ] 	
...
Bots = [mid,"Mid Admin/Mid Kamu","Mid Assist 1","Mid Assist 2","Mid Assist 3","Mid Assist 4","Mid Assist 5","Mid Assist 6","Mid Assist 7"]
admsa = "Mid Admin/Mid Kamu"
admin = "u60b72526c2b939a3c9b71d25a9a1a183" 
crash = "Mid Admin/Mid Kamu','"
...
wait = {
    ...
    'message':" ",
    "lang":"JP",
    "comment":"Aᴜᴛᴏ Lɪᴋᴇ ʙʏ Ꭲ̡̦͎͇͈̘̻̎̉̅́̒͗ͅϵѧᴍ̸̩̟̗͎̯͙̺̺̜̬̙̟̀̑̓͋̐͆͌̓̒́̒͗͒͑̚͟͜ᎶʀҽѧᴛᏴøᴛ̢͓̹̗̘̠̪̖͗̃̄̅̆̽̀̕͜͞\n\nline://ti/p/TtnMdaDG_d",
    "commentOn":True,
    "likeOn":True,
    "commentBlack":{},
    "wblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "Mid Admin/Mid Kamu":
                    if "join:" in msg.text:
